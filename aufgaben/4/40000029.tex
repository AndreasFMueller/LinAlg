...
%F"ur ein grosses Teleskop, welches bei $45^\circ$ n"ordlicher Breite
%aufgestellt werden soll, ist diese Montierungsart zu simpel.
%Um die
%Drehung der Erde kompensieren zu k"onnen, wird die vertikale Achse
...
%und "aquatoriale Montierung (rechts)\label{40000029:altaz}}
%\end{figure}
...
%\item Im "aquatorialen Koordinatensystem entspricht $\vec e_3$
