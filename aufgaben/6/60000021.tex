...
=
\begin{pmatrix*}[r]
-1 &   0\phantom{.000} &  0\phantom{.000}\\
 0 &   0.5\phantom{00} &  0.866\\
 0 &   0.866           & -0.5\phantom{00}\\
\end{pmatrix*}
\]
gegeben.
\begin{center}
...
\[
\begin{aligned}
\vec b_8 &= \begin{pmatrix*}[r]225\\136\\1\end{pmatrix*}
&&\text{und}&
\vec b_9 &= \begin{pmatrix*}[r]197\\137\\1\end{pmatrix*}.
\end{aligned}
\]
...
=
\frac{\begin{pmatrix*}[r]-0.8504\\ 0.8043\\ 0\phantom{.0000}\end{pmatrix*}
\cdot\begin{pmatrix*}[r]-0.4910\\ 0.8368\\ 0\phantom{.0000}\end{pmatrix*}}
...
\[
  ...
  =
\begin{pmatrix*}[r] 0\phantom{.000}\\ 0.866 \\ 0.5\phantom{00} \end{pmatrix*}
\]
