...
\[
\begin{aligned}
\vec b_S &= \begin{pmatrix*}[r]229\\613\\1\end{pmatrix*}
&&\text{und}&
\vec b_G &= \begin{pmatrix*}[r]229\\94\\1\end{pmatrix*}.
\end{aligned}
\]
...
1.895\\
325.006
\end{pmatrix*}\right| = \sqrt{0^2 + (1.895)^2 + 325.006^2} = 325.01.[r]
\]
