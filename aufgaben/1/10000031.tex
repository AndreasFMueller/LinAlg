...
(-1)\cdot(-1) + (-1)\cdot6 + 5\cdot3
	&\scriptstyle (-1)\cdot(-3) + (-1)\cdot(-2) + 5\cdot(-1)
		&\scriptstyle (-1)\cdot(-2) + (-1)\cdot(-18) + 5\cdot(-4)\\
\scriptstyle (-3)\cdot(-1) + 1\cdot6 + (-3)\cdot3
	&\scriptstyle (-3)\cdot(-3) + 1\cdot(-2) + (-3)\cdot(-1)
		&\scriptstyle (-3)\cdot(-2) + 1\cdot(-18) + (-3)\cdot(-4)\\
\scriptstyle 0\cdot(-1) + (-1)\cdot6 + 2\cdot3
	&\scriptstyle 0\cdot(-3) + (-1)\cdot(-2) + 2\cdot(-1)
		&\scriptstyle 0\cdot(-2) + (-1)\cdot(-18) + 2\cdot(-4)
\end{pmatrix}
}
\\
&=
...
\begin{align*}
b&=
\begin{pmatrix*}[r]-1\\3\\1\end{pmatrix*}
&
x&=A^{-1}b=
\frac1{10}
\begin{pmatrix*}[r]
...
\frac1{10}
\begin{pmatrix*}[r]
 \left|\begin{matrix*}[r] 1&-3\\-1& 2\end{matrix*}\right|&
-\left|\begin{matrix*}[r]-1& 5\\-1&\phantom{-}2\end{matrix*}\right|&
 \left|\begin{matrix*}[r]-1& 5\\ 1&-3\end{matrix*}\right|\\[12pt]
-\left|\begin{matrix*}[r]-3&-3\\ 0& 2\end{matrix*}\right|&
 \left|\begin{matrix*}[r]-1& 5\\ 0&\phantom{-}2\end{matrix*}\right|&
-\left|\begin{matrix*}[r]-1& 5\\-3&-3\end{matrix*}\right|\\[12pt]
 \left|\begin{matrix*}[r]-3& 1\\ 0&-1\end{matrix*}\right|&
-\left|\begin{matrix*}[r]-1&-1\\ 0&-1\end{matrix*}\right|&
 \left|\begin{matrix*}[r]-1&-1\\-3& 1\end{matrix*}\right|
\end{pmatrix*}
=
\frac1{10}
\begin{pmatrix*}[r]
