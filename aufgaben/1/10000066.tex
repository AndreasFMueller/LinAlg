...
\notag
\end{align}
Dabei haben wir den etwas unschönen Bruch $q=\frac{v}{2(u-1)}$ abgekürzt.
...
Dort steht, dass die rechte Seite für $u=1$ zu $v$ wird, d.~h.~es gibt
unendlich viele Lösungen genau dann, wenn $v=0$.
\item
