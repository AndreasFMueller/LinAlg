...
\draw[color=red,line width=1pt,line join=bevel]
	...
	--({-\l+\rtwo*(cos(6)-1)},{-\rtwo*sin(6)})
	--(2.5,0);
\fill[color=red] (2.5,0) circle[radius=0.1];

\node at (-\l,0) [below right] {$-\l$};
\node at (0,0) [below left] {$0$};
\fill (-\l,0) circle[radius=0.1];

\node at (-2.5,-3.3) [above,rotate=-7] {$r_1 = \rone$};

\draw[<-,line width=0.7pt]
	({-\l+\rtwo*(cos(6)-1)},{\rtwo*sin(6)})
	--
	({-\l-\rtwo+(\rtwo+3)*cos(6)},{(\rtwo+3)*sin(6)});
\node at (-11,0.6) [rotate=6,above] {$r_2=\rtwo$};
