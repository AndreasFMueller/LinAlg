...
{
\begin{pmatrix*}[r]
\scriptstyle (-7)\cdot(-7)+(-16)\cdot1+(-8)\cdot 5
	&\scriptstyle (-7)\cdot(-16) + (-16)\cdot 3 + (-8)\cdot 10
		&\scriptstyle (-7)\cdot(-8) + (-16)\cdot 1 + (-8)\cdot 6\\
\scriptstyle 1\cdot(-7) + 3\cdot 1 + 1\cdot 5
	&\scriptstyle 1\cdot(-16) + 3\cdot 3 + 1\cdot10
		&\scriptstyle 1\cdot(-8) + 3\cdot 1 + 1\cdot 8\\
\scriptstyle 5\cdot(-7) + 10\cdot 1+ 6\cdot 5
	&\scriptstyle 5\cdot(-16) + 10\cdot 3 + 6\cdot 10
		&\scriptstyle 5\cdot(-8) + 10\cdot + + 6\cdot 6\\
\end{pmatrix*}
}
\\
&=
