...
$w_3$ immer verschwindet, und analog für die anderen Seiten
(Abbildung~\ref{40000016:bild}).
\begin{figure}
\centering
...
Die Koordinaten sind nicht unabhängig, es gilt immer $w_1+w_2+w_3=1$.
Daher ist es auch nicht möglich, eine $3\times 2$-Matrix zu finden, mit
der man die Koordinaten $(x_1,x_2)$ in der Ebene in die drei Koordinaten
$(w_1,w_2,w_3)$ umrechnen kann, eine solche Matrix würde den Punkt $(0,0)$
immer auf $(0,0,0)$ abbilden.

Setzt man dagegen für alle Punkte $x_3=1$, dann kann man eine $3\times 3$-Matrix
$A$ angeben,
...
\item
Berechnen Sie die Matrix für die Punkte $B_1=(4,1)$, $B_2=(16,-1)$ und
$B_3=(10,12)$.
\item 
...
\thema{Umkehrabbildung}
\thema{baryzentrische Koordinaten}
