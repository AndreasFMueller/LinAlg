...
Signale $U=R-V$ und $V=B-V$ benötigt werden.
...
und damit zu einer Verschiebung der Farben auf dem Farbkreis führen
würde, muss der Sender dem Empfänger die genaue Phase mitteilen.
...
zur Verfügung und nur mit der Dichte, die durch die Frequenz des Farbträgers
limitiert ist.
...
Bei PSK waren dies die Punkte $(1,0)$  und $(-1,0)$ in der $I$-$Q$-Ebene
verwendet.
...
$\vec{v}_k$, also $\hat{v}\in T_{\vec{v}_k}$, dann codieren wir ihn
