...
sondern
\index{regulaer@regul\är}
\index{singulaer@singul\är}
\begin{compactenum}
...
\end{tabular}
\end{gather*}
\index{Vorwaertsreduktion@Vorw\ärtsreduktion}
\index{Rueckwaertseinsetzen@R\ückw\ärtseinsetzen}
...
\index{abhaengig@abh\ängig, linear}
\index{linear abh\ängig}
Im Gleichungssystem
\begin{align*}
x+2y&=5\\
2x+4y&=10
