...
\caption{Ein Kalzit- oder Kalkspat-Kristall hat die Form eines Parallelipeds.
...
\end{figure}
Das Parallelepiped wird auch als Spat bezeichnet.
...
von Parallelepipeds.
Das Volumen $V(\vec{a},\vec{b},\vec{c})$ des von
$\vec{a}$,
$\vec{b}$ und
$\vec{c}$ aufgespannten Parallelepipeds
heisst daher auch das Spatvolumen.
