...
=
{\color{red}t}\begin{pmatrix}u_1\\u_1\\u_3\end{pmatrix}
+
...
\begin{equation}
\begin{linsys}{5}
\color{red}x& & & & &-&u_1\color{red}t& &    &=&q_1\phantom{,}\\
 & &\color{red}y& & &-&u_2\color{red}t& &    &=&q_2\phantom{,}\\
 & & & &\color{red}z&-&u_3\color{red}t& &    &=&q_3\phantom{,}\\
\color{red}x& & & & & &    &-&v_1\color{red}s&=&w_1\phantom{,}\\
 & &\color{red}y& & & &    &-&v_2\color{red}s&=&w_2\phantom{,}\\
 & & & &\color{red}z& &    &-&v_3\color{red}s&=&w_3,
\end{linsys}
\end{equation}
dem das Tableau
\begin{equation}
