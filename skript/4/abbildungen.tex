...
Damit zwei Vektoren $u$ und $v$ nach Abbildung
...
%
\subsection{Vertauschung der Koordinatenachsen als orthogonale Abbildung}
...
Wir bestimmen die Transformationsmatrix mit dem Verfahren von 
Abschnitt~\ref{subsection:basistransformation}.
...
\end{tabular}
\]
woraus wir die Transformationsmatrix
\begin{equation}
T
=
\begin{pmatrix}
...
\end{equation}
ablesen können.
Durch nachrechnen können wir überprüfen, dass $T^tT=E$ ist, dass die
Matrix $T$ also orthogonal ist.
